...
// homemade components
export { GetStartedButton } from '@/features/mapping/components/GetStartedButton';
export type { GetStartedButtonProps } from '@/features/mapping/components/GetStartedButton';
